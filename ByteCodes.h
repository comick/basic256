...
#define OP_READBYTE 	       	OP_TYPEARGNONE + 0x77
#define OP_WRITEBYTE 	       	OP_TYPEARGNONE + 0x78
#define OP_STACKDUP 	       	OP_TYPEARGNONE + 0x79
#define OP_STACKDUP2 	       	OP_TYPEARGNONE + 0x7a
#define OP_STACKSWAP2 	       	OP_TYPEARGNONE + 0x7b
