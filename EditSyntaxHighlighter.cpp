...
void EditSyntaxHighlighter::initConstants() {
    ...
    constantPatterns
            ...
            << "ERROR_FILERESET"					//ERROR_FILERESET
            << "ERROR_ARRAYSIZELARGE"				//ERROR_ARRAYSIZELARGE
            << "ERROR_ARRAYSIZESMALL"				//ERROR_ARRAYSIZESMALL
            << "ERROR_NOSUCHVARIABLE"				//ERROR_NOSUCHVARIABLE
            << "ERROR_ARRAYINDEX"					//ERROR_ARRAYINDEX
            << "ERROR_STRNEGLEN"					//ERROR_STRNEGLEN
            << "ERROR_STRSTART"						//ERROR_STRSTART
            << "ERROR_STREND"						//ERROR_STREND
            << "ERROR_NONNUMERIC"					//ERROR_NONNUMERIC
            << "ERROR_RGB"							//ERROR_RGB
            << "ERROR_PUTBITFORMAT"					//ERROR_PUTBITFORMAT
            << "ERROR_POLYARRAY"					//ERROR_POLYARRAY
            << "ERROR_POLYPOINTS"					//ERROR_POLYPOINTS
            << "ERROR_IMAGEFILE"					//ERROR_IMAGEFILE
            << "ERROR_SPRITENUMBER"					//ERROR_SPRITENUMBER
            << "ERROR_SPRITENA"						//ERROR_SPRITENA
            << "ERROR_SPRITESLICE"					//ERROR_SPRITESLICE
            << "ERROR_FOLDER"						//ERROR_FOLDER
            << "ERROR_INFINITY"						//ERROR_INFINITY
            << "ERROR_DBOPEN"						//ERROR_DBOPEN
            << "ERROR_DBQUERY"						//ERROR_DBQUERY
            << "ERROR_DBNOTOPEN"					//ERROR_DBNOTOPEN
            << "ERROR_DBCOLNO"						//ERROR_DBCOLNO
            << "ERROR_DBNOTSET"						//ERROR_DBNOTSET
            << "ERROR_NETSOCK"						//ERROR_NETSOCK
            << "ERROR_NETHOST"						//ERROR_NETHOST
            << "ERROR_NETCONN"						//ERROR_NETCONN
            << "ERROR_NETREAD"						//ERROR_NETREAD
            << "ERROR_NETNONE"						//ERROR_NETNONE
            << "ERROR_NETWRITE"						//ERROR_NETWRITE
            << "ERROR_NETSOCKOPT"					//ERROR_NETSOCKOPT
            << "ERROR_NETBIND"						//ERROR_NETBIND
            << "ERROR_NETACCEPT"					//ERROR_NETACCEPT
            << "ERROR_NETSOCKNUMBER"				//ERROR_NETSOCKNUMBER
            << "ERROR_PERMISSION"					//ERROR_PERMISSION
            << "ERROR_IMAGESAVETYPE"				//ERROR_IMAGESAVETYPE
            << "ERROR_DIVZERO"						//ERROR_DIVZERO
            << "ERROR_BYREF"						//ERROR_BYREF
            << "ERROR_BYREFTYPE"					//ERROR_BYREFTYPE
            << "ERROR_FREEFILE"						//ERROR_FREEFILE
            << "ERROR_FREENET"						//ERROR_FREENET
            << "ERROR_FREEDB"						//ERROR_FREEDB
            << "ERROR_DBCONNNUMBER"					//ERROR_DBCONNNUMBER
            << "ERROR_FREEDBSET"					//ERROR_FREEDBSET
            << "ERROR_DBSETNUMBER"					//ERROR_DBSETNUMBER
            << "ERROR_DBNOTSETROW"					//ERROR_DBNOTSETROW
            << "ERROR_PENWIDTH"						//ERROR_PENWIDTH
            << "ERROR_COLORNUMBER"					//ERROR_COLORNUMBER
            << "ERROR_ARRAYINDEXMISSING"			//ERROR_ARRAYINDEXMISSING
            << "ERROR_IMAGESCALE"					//ERROR_IMAGESCALE
            << "ERROR_FONTSIZE"						//ERROR_FONTSIZE
            << "ERROR_FONTWEIGHT"					//ERROR_FONTWEIGHT
            << "ERROR_RADIXSTRING"					//ERROR_RADIXSTRING
            << "ERROR_RADIX"						//ERROR_RADIX
            << "ERROR_LOGRANGE"						//ERROR_LOGRANGE
            << "ERROR_STRINGMAXLEN"					//ERROR_STRINGMAXLEN
            << "ERROR_NOTANUMBER"					//ERROR_NOTANUMBER
            << "ERROR_PRINTERNOTON"					//ERROR_PRINTERNOTON
            << "ERROR_PRINTERNOTOFF"				//ERROR_PRINTERNOTOFF
            << "ERROR_PRINTEROPEN"					//ERROR_PRINTEROPEN
            << "ERROR_WAVFILEFORMAT"				//ERROR_WAVFILEFORMAT
            << "ERROR_WAVNOTOPEN"					//ERROR_WAVNOTOPEN
